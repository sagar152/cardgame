...
export default class Quiz extends Component {
    ...
    render(){
      ...
      <Grid container spacing={2} columnSpacing={{ xs: 2, sm: 2, md: 2 }}  sx={{
        ...
        <Item style={{ backgroundColor: '#2980B9',color:'white', borderTopRightRadius: '10px', borderTopLeftRadius: '10px', borderBottomLeftRadius: '0px', borderBottomRightRadius: '0' }}>  <div className={styles.htmlstands}>
